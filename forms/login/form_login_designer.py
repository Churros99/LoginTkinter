...
class FormLoginDesigner:
    ...
    def __init__(self):
        ...
        inicio.pack(fill=tk.X, padx=15, pady=20)
        inicio.bind("<Return>", (lambda event:self.verificar()))
        
        registro = tk.Button(frame_form_fill, text="Registrar Usuario", font=('Times',15), bg='#fcfcfc', bd=0, fg='#3a7ff6', command=self.userRegister)
